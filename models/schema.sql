...
USE chat_db;
INSERT INTO Comments (post,Author,location,ifComment,createdAt, updatedAt, postId)
VALUE("Hello","Doe","Memes",FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 1);
...
INSERT INTO Comments (post,Author,location,ifComment,createdAt, updatedAt, postId)
VALUE("sup","John","School",FALSE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 1);
